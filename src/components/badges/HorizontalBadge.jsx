 ...
 * Wide horizontal layout (~6.8:1 ratio)
 * Based on official la.io horz.svg
 * No background - logo elements only
 */
export function HorizontalBadge({ slug = '', color = '#101948', size = 'm' }) {
  const width = getSizePixels(size)
  const height = Math.round(width / 6.8)

  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 459.69 67.88"
      width={width}
      height={height}
      role="img"
